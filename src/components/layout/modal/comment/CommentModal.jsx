...
function CommentModal({ createComment, setCreateComment }) {
    ...
    return (
        <Dialog
            open={createComment.isSignInModalOpen}
            onClose={() => setCreateComment({ ...createComment, isSignInModalOpen: false, message: '' })}
