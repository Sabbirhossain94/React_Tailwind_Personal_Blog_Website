    ...
    return (
        <div className='bg-gray-100 w-full overflow-hidden flex pt-[70px] dark:bg-zinc-800 min-h-screen relative'>
            ...
            <SignOutModal
                ...
                setIsOpen={setIsOpen}
            />
            <aside className={`${sideBarOpen ? "translate-x-0" : "-translate-x-full"} pt-16 lg:pt-4 transition-transform fixed w-64 left-0 top-20 bg-white dark:bg-zinc-900 z-40 bottom-0 border-t border-r border-zinc-300 dark:border-zinc-700 -translate-x-full lg:translate-x-0`}>
