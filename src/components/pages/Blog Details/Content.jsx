            ...
            <div className="relative">
              <div className="flex flex-col justify-center">
                ...
                <div className="mt-3 px-8 flex items-center">
                  ...
                  <span className="text-[10px] ml-6 font-semibold bg-blue-50 dark:bg-teal-900/30 rounded-xl border border-blue-500 dark:border-teal-500 px-2 py-[2px] dark:text-teal-600 text-blue-500">
                    {blog.topic}
                  </span>
                </div>
