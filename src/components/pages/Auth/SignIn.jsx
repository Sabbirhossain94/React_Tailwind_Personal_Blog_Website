...
import ResetPassEmailModal from "../../layout/modal/auth/ResetPassEmailModal";
...
export default function SignIn() {
  ...
  return (
    <div className="flex min-h-screen flex-col justify-center py-12 sm:px-6 lg:px-8 bg-gray-100 dark:bg-zinc-800">
      <ResetPassEmailModal
        isResetEmailModalOpen={isResetEmailModalOpen}
        setIsResetEmailModalOpen={setIsResetEmailModalOpen}
      />
          ...
          <div className="mt-6 px-2">
            <form onSubmit={handleLogin}>
              ...
              <div className="text text-right mt-4">
                <button type="button" onClick={resetPassword} className="text-blue-500 dark:text-teal-500 underline cursor-pointer">Forgot your password?</button>
              </div>
              <div className="mt-6">
