...
export default function Footer() {
  return (
    <footer className="text-gray-600 mx-auto body-font flex justify-center items-center py-10 dark:bg-zinc-900/95 bg-slate-800 relative bottom-0 left-0 right-0">
